...
WhitelistQuery pixel8() {
  return {"Pixel 8", 34, "dabai_dcw", "2460", "powered_hub_a", "0.1.0"};
}
...
TEST(AndroidWhitelist, AllowsListedPhones) {
  ...
  EXPECT_TRUE(table.allows(
      {"SM-S911B", 33, "dabai_dcw", "2460", "powered_hub_a", "0.1.0"}));
  EXPECT_TRUE(table.allows(
      {"2201123G", 33, "dabai_dcw", "2460", "powered_hub_a", "0.1.0"}));
  EXPECT_TRUE(table.allows(
      {"Pixel 8", 34, "dual_rgb_uvc", "uvc_host", "none", "0.1.0"}));
  EXPECT_TRUE(table.allows(
      {"Pixel 8", 34, "fake", "replay", "none", "0.1.0"}));
}
...
TEST(AndroidWhitelist, DeniesUnknownAndIos) {
  ...
  EXPECT_FALSE(table.allows(
      {"iPhone15,2", 17, "dabai_dcw", "2460", "powered_hub_a", "0.1.0"}));
  EXPECT_FALSE(table.allows(
      {"Pixel 3", 34, "dabai_dcw", "2460", "powered_hub_a", "0.1.0"}));
  EXPECT_FALSE(table.allows(
      {"Pixel 8", 34, "orbbec_gemini_e", "3460", "powered_hub_a", "0.1.0"}));
}
