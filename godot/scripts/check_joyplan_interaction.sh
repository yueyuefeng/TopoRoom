...
has "$root/godot/app/joyplan_flow/free_draw.gd" "DrawToolbar"
has "$root/godot/app/joyplan_flow/free_draw.gd" "SAFE_BOTTOM"
lacks "$root/godot/app/joyplan_flow/free_draw.gd" "JoyplanChrome.step_bar"
lacks "$root/godot/app/joyplan_flow/free_draw.gd" "offset_top = 56"
