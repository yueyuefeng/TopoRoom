...
has "$root/godot/app/photo_stub.gd" "_place_ctx"
...
has "$root/godot/app/edit_3d.gd" "right_circles"
has "$root/godot/app/ui/minimap.gd" "_draw_fov"
has "$root/godot/app/ui/ruler_sheet.gd" "标尺显示"
has "$root/godot/app/ui/ruler_sheet.gd" "墙厚信息"
has "$root/godot/app/ui/ruler_sheet.gd" "全选"
has "$root/godot/app/edit_3d.gd" "PAGE_PINK"
