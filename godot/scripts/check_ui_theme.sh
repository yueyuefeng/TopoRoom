...
has "$root/godot/app/photo_stub.gd" "进入 3D"
has "$root/godot/app/photo_stub.gd" "_run_vision"
...
has "$root/godot/app/photo_stub.gd" "JoyplanChrome"
has "$root/godot/app/edit_3d.gd" "lighting_pressed"
has "$root/godot/app/lighting.gd" "白天"
